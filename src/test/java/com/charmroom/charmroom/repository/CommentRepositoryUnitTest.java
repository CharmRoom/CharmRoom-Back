...
public class CommentRepositoryUnitTest {
	...
	class Read {
		...
		public void success() {
			...
			// when
			var foundBoard = commentRepository.findById(comment.getId());
			// then
			assertThat(foundBoard).isPresent();
			assertThat(foundBoard).get().isEqualTo(saved);
		}
	...
	class Update {
		...
		public void success() {
			...
			// then
			var foundBoard = commentRepository.findById(comment.getId()).get();
			assertThat(foundBoard).isNotNull();
			assertThat(foundBoard.getBody()).isEqualTo("New contents");
		}
	}
	...
	class Delete {
		...
		public void success() {
			...
			// then
			var foundBoards = commentRepository.findAll();
