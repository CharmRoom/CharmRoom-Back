...
public class UserService {
	...
	public User create(String username, String email, String nickname, String password) {
		if (isDuplicatedUsername(username)) throw new CustomException(CustomError.DUPLICATED_USERNAME);
		if (isDuplicatedEmail(email)) throw new CustomException(CustomError.DUPLICATED_EMAIL);
		if (isDuplicatedNickname(nickname)) throw new CustomException(CustomError.DUPLICATED_NICKNAME);
	...
	public String findUsernameByEmail(String email) {
		User user = userRepository.findByEmail(email)
				.orElseThrow(() -> new CustomException(CustomError.NOTFOUND_USER, "email: " + email));
	...
	public User changePassword(String username, String password) {
		User user = userRepository.findByUsername(username)
				.orElseThrow(() -> new CustomException(CustomError.NOTFOUND_USER, "username: " + username));
